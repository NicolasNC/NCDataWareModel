...
NSString * const TMDiskCachePrefix = @"com.nicoals.diskcache";//@"com.tumblr.TMDiskCache";
NSString * const TMDiskCacheSharedName =  @"diskCache";//@"TMDiskCacheShared";
...
- (id <NSCoding>)objectForKey:(NSString *)key
{
    ...
    [self objectForKey:key block:^(TMDiskCache *cache, NSString *key, id <NSCoding> object, NSURL *fileURL) {
        objectForKey = object;
        LOCK_SIGNAL(dispatch_semaphore_signal(semaphore););
    }];
